...
function Mod.init()
  ...
  command! ViperBuffers :lua require("viper.functions").buffers()
  ...
  command! -nargs=* ViperGitStatus :lua require("viper.functions").files("git -c color.status=always status --short --untracked-files", { pattern = ".* (.*)" })
