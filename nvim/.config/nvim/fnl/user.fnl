           ...
           {:extensions {:rkt :racket}
            ...
            {:nt
             (fn []
               ...
               (vim.cmd "2match Comment /^#lang .*$/")
               (vim.cmd "syntax match Keyword /where/"))}
            :function_literal {}
            :function_complex {}}}))})
...
(use :junegunn/rainbow_parentheses.vim {:config (fn []) :ft [:racket]})
...
(use :j-hui/fidget.nvim {:config (fn []
