local function init()
  ...
  local function filepath()
    return string.format(v.simplify(v.expand("%")), "%s")
  end
  ...
  local sep = {["pyramid-right"] = "\238\130\176", ["pyramid-empty-right"] = "\238\130\177", ["pyramid-left"] = "\238\130\178", ["pyramid-empty-left"] = "\238\130\179", ["semi-sphere-right"] = "\238\130\180", ["semi-sphere-empty-right"] = "\238\130\181", ["semi-sphere-left"] = "\238\130\182", ["semi-sphere-empty-left"] = "\238\130\183", ["tri-up-left"] = "\238\130\184", ["slash-left"] = "\238\130\185", ["tri-up-right"] = "\238\130\186", ["slash-right"] = "\238\130\187", ["tri-down-left"] = "\238\130\188", ["tri-down-right"] = "\238\130\190", space = " "}
  local colors0 = {fg = hi_attr("normal", "fg"), bg = hi_attr("normal", "bg"), fg0 = hi_attr("GruvboxFg0"), fg1 = hi_attr("GruvboxFg1"), fg2 = hi_attr("GruvboxFg2"), fg3 = hi_attr("GruvboxFg3"), fg4 = hi_attr("GruvboxFg4"), bg0 = hi_attr("GruvboxBg0"), bg1 = hi_attr("GruvboxBg1"), bg2 = hi_attr("GruvboxBg2"), bg3 = hi_attr("GruvboxBg3"), bg4 = hi_attr("GruvboxBg4"), purple = hi_attr("GruvboxPurple", "fg"), blue = hi_attr("GruvboxBlue", "fg"), normal = hi("normal"), StatusLine = hi("StatusLine")}
  local group = {fileicon = {colors0.normal.bg, colors0.purple}, status = "StatusLine"}
  ...
  section["left"] = {{FileIcon = theme({provider = FileIcon})}, {FilePath = theme({provider = filepath})}, {LineColumn = theme({provider = cursor})}, {LinePercent = theme({provider = LinePercent})}}
  section["mid"] = {}
  section["right"] = {{LspStatus = theme({provider = LspStatus})}}
  return nil
end
return init
